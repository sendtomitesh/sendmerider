...
const AppConfig sendmeRider = AppConfig(
  ...
  packagePassword: 'SMWL2024@Rider',
...
const AppConfig eatozRider = AppConfig(
  ...
  packageName: 'today.eatoz.rider',
  packagePassword: 'SMWL2024@EatozRider',
...
const AppConfig sendme6Rider = AppConfig(
  ...
  name: 'SendMe6 Rider',
  color: Color(0xff1982C4),
  packageName: 'today.sendme6.rider',
  packagePassword: 'SMWL2024@SendMe6Rider',
...
const AppConfig hopshopRider = AppConfig(
  ...
  packageName: 'today.hopshop.rider',
  packagePassword: 'SMWL2024@HopshopRider',
...
const AppConfig tyebRider = AppConfig(
  ...
  packageName: 'today.tyeb.rider',
  packagePassword: 'SMWL2024@TyebRider',
...
const AppConfig sendmeLebanonRider = AppConfig(
  ...
  color: Color(0xff1982C4),
  packageName: 'today.sendmelebanon.rider',
  packagePassword: 'SMWL2024@SendMeLebanonRider',
...
const AppConfig sendmeTalabetakRider = AppConfig(
  ...
  packageName: 'today.talabetak.rider',
  packagePassword: 'SMWL2024@TalabetakRider',
...
const AppConfig sendmeShrirampurRider = AppConfig(
  ...
  color: Color(0xff29458E),
  packageName: 'today.sendmeshrirampur.rider',
  packagePassword: 'SMWL2024@SendMeShrirampurRider',
